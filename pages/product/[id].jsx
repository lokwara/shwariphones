...
function Product() {
  ...
  return (
    <div>
      <NextSeo
        canonical={`https://shwariphones.africa/products/${id}}`}
        title="Shwariphones Africa"
        description={
        ...
        itemListElements={[
          {
            ...
            item: "https://shwariphones.africa/all",
          },
          {
            position: 2,
            name: variant?.brand,
            item: `https://www.shwariphones.africa/all?model=${variant?.brand}`,
          },
          {
            position: 3,
            name: variant?.model,
      ...
      <Reviews reviews={variant?.reviews} product={variant?.model} />
    ...
    <div className="py-4 space-y-4">
      <div className="flex space-x-3">
        ...
        <div>
          ...
          <p>
            Purchased on{" "}
            {moment(new Date(parseInt(review?.date))).format("Do MMM YYYY")}
          </p>

          <Badge className="mt-2" color="#E3F77E" radius={12}>
            <div className="flex items-center text-black normal-case space-x-1">
              <IconCheck size={18} stroke={1} />
              <p className="text-[0.8rem] font-light">Verified purchase</p>
            </div>
          </Badge>
        </div>
      </div>
...
const Reviews = ({ reviews, product }) => {
  ...
  return (
    <div className="px-6 py-12">
      <div className="space-y-2">
        <strong>{product}&apos;s customer reviews</strong>
        <div className="flex items-center space-x-2">
          <Rating defaultValue={totalRating()} />
          <strong>{totalRating()}/5</strong>
        </div>

        <div className="flex space-x-2">
          <IconShieldCheckFilled stroke={1} />
